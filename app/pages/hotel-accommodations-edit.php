                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <fieldset class="form-fieldset">
                                ...
                                <button type="submit"   onclick="kobySubmit('?do=hotel-accommodations&q=edit&id=<?=$view->accommodation_id?>','hotel-accommodations')" class="btn btn-block btn-success btn-lg"> Speichern und Schließen <i class="fe fe-save"></i>  </button>
