                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="<?=$view->semt_adi?>">
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4">
                            <fieldset class="form-fieldset">
                                ...
                                <button type="submit"   onclick="kobySubmit('?do=district&q=edit&id=<?=$view->id?>','district-list')" class="btn btn-block btn-success btn-lg"> Speichern und Schließen <i class="fe fe-save"></i>  </button>
                            </fieldset>
                        </div>
                    </div>
                </div>
