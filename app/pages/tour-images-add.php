...
<div class="my-3 my-md-5">
    <div class="container">
        <div class="page-header">
            <h1 class="page-title">
                <strong><?=$view->name?></strong> isimli Tur'a Resim Ekle
            </h1>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 col-lg-8">
                            ...
                            <input type="hidden" name="tour_id" value="<?=$view->name?>" >
                        ...
                        <div class="col-md-4 col-lg-4">
                            ...
                            <fieldset class="form-fieldset">
                                <button type="submit" onclick="kobySubmit('?do=tour&q=pic-add&id=<?=$id?>','tour-images-list?id=<?=$id?>')" class="btn btn-block btn-success btn-lg"> Kaydet ve Düzenle <i class="fe fe-save"></i>  </button>
                            </fieldset>
                        </div>
                    </div>
                </div>
