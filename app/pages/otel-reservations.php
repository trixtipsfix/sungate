            ...
            <div class="card">
                <div class="card-body">
                    <table class="table card-table table-vcenter text-nowrap" id="koby_table">
                        ...
                        <?php
                        $rows = $db->get_results("SELECT * FROM reservations WHERE rezervation_type = 'hotel' ORDER BY id DESC ");
                        foreach ($rows as $row){
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    ...
                                    <a href="javascript:void(0)" onclick="kobySingle('<?=$row->id?>','?do=otel-rezervasyon&q=delete','otel-reservations')" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Löschen"><i class="fe fe-trash"></i> </a>
                                </th>
                            </tr>
                        <?php } ?>
