        ...
        <div class="page-header">
            ...
            <div class="page-options d-flex ">
                <div class="page-subtitle ">
                    <a href="hotel-categories"  class="btn btn-sm btn-orange mr-4"> <i class="fa fa-long-arrow-left"></i> Otel Kategorilerine Geri Dön   </a>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <fieldset class="form-fieldset">
                                ...
                                <button type="submit"   onclick="kobySubmit('?do=hotel-categories&q=edit&id=<?=$view->category_id?>','hotel-categories')" class="btn btn-block btn-success btn-lg"> Speichern und Schließen <i class="fe fe-save"></i>  </button>
